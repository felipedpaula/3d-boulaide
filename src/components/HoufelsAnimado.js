        ...
        <>
            <Canvas style={{ width: '100vw', height: '100vh' }}>
                ...
                <Suspense fallback={null}>
                    <LazyGLTFModel path="/models/houfels_0001_animado.gltf" pointsOfInterest={pointsOfInterest} onPointClick={handlePointClick} />
                </Suspense>
                <OrbitControls />
