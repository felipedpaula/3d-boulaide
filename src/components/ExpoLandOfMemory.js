        ...
        <>
            <Canvas style={{ width: '100vw', height: '100vh' }}>
                ...
                <Suspense fallback={null}>
                    <LazyGLTFModel path="/models/expo_land_of_memory.gltf" pointsOfInterest={pointsOfInterest} onPointClick={handlePointClick} />
                </Suspense>
                <OrbitControls />
...
export default ExpoLandOfMemory;
