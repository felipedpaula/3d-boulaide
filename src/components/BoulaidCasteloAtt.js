        ...
        <>
            <Canvas style={{ width: '100vw', height: '100vh' }}>
                ...
                <Suspense fallback={null}>
                    <LazyGLTFModel path="/models/novos/boulaid_0001.gltf" pointsOfInterest={pointsOfInterest} onPointClick={handlePointClick} />
                </Suspense>
                <OrbitControls />
...
export default BoulaidCasteloAtt;
